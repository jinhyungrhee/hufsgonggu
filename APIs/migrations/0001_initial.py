# Generated by Django 3.2.6 on 2021-08-12 16:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size', models.CharField(choices=[('M', 'Medium'), ('L', 'Large'), ('S', 'Small')], max_length=10, null='True', verbose_name='사이즈')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('satisfaction', models.CharField(choices=[('3', '3'), ('2', '2'), ('5', '5'), ('4', '4'), ('1', '1')], max_length=10, verbose_name='만족도')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='등록날짜')),
            ],
            options={
                'verbose_name': '리뷰',
